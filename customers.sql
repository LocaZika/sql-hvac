...
CREATE TABLE USERS.CUSTOMERS(
	...
	ACCOUNT_TYPE USERS.ACCOUNT_TYPE NOT NULL DEFAULT 'local',
	ROLE USERS.USER_ROLES NOT NULL DEFAULT 'customer',
...
INSERT INTO USERS.CUSTOMERS(EMAIL, PASSWORD, NAME, PHONE, ADDRESS, IS_ACTIVE, CODE_ID)
VALUES ('admin@mail.com', '123', 'admin', '015348975', 'HN', true, 'code id in here');
...
---SET UPDATE TIME---
CREATE FUNCTION USERS.SET_UPDATED_AT_FUNC()
RETURNS TRIGGER AS $$
BEGIN
...
FOR EACH ROW EXECUTE USERSCHECK_UNIQUE_EMAIL_PHONE();
